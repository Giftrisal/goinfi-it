# Agent Guidelines & Memory — Goinfi Labs

Please refer to `PROJECT_CONTEXT.md` for all architectural, branding, and deployment specifications of **Goinfi Labs** (`labs.goinfi.biz`).

## Key Guidelines:
- **Brand Identity:** Always maintain the exact brand name **Goinfi Labs** (under parent `goinfi.biz`).
